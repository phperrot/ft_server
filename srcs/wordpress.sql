...
(1, 1, 'phperrot', 'https://profile.intra.42.fr/users/phperrot', 'https://profile.intra.42.fr/users/phperrot', '', '2020-02-25 23:01:28', '2020-02-25 22:01:28', 'Bonjour correcteur, ceci est un commentaire.\n', 0, '1', '', '', 0, 0);
...
(3, 'blogname', 'Mon premier projet docker', 'yes'),
(4, 'blogdescription', 'Un site utilisant parfaitement WordPress', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'phperrot@student.42.fr', 'yes'),
...
(1, 'Articles interessants', 'non-classe', 0);
...
(1, 1, 'nickname', 'phperrot'),
(2, 1, 'first_name', 'Philemon'),
(3, 1, 'last_name', 'Perrot'),
(4, 1, 'description', ''),
...
(1, 'phperrot', '$P$BLsYodJhloLCZ7XnnFSDDxzx5w7t7L/', 'phperrot', 'phperrot@student.42.fr', '', '2020-12-25 13:01:27', '', 0, 'phperrot');
